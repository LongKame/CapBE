...
public class PaymentConfig {
    ...
    public static final String TMN_CODE  = "AS8K261Q";
    public static final String CURRCODE = "VND";
    public static final String LOCATE = "vn";
    public static final String RETURNURL = "http://localhost:4200/thong-tin-thanh-toan"; // thong bao khi da thanh toan don hang
    public static final String VNP_PAYURL = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html"; // di den trang thanh toan
    public static final String CHECKSUM = "NIBUCIFCXPXTEQPVEWMLEBNHABUAHAOP";
